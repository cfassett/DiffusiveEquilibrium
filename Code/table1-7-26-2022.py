...
def man(option, opt, value, parser):
    ...
    print >>sys.stderr, '''\
Table version of lifetimes from Fig 1'''
    sys.exit()
...
def main():
    try:
        ...
        sizes_m=[1.0,1.41,2.0,2.83,4.0,5.66,8.0,10.0,11.31,16.0,20.0,22.63,32.0,40.0,45.25,64.0,80.0,90.51,128.0,160.0,181.0]
        
        for sizem in sizes_m:
            sizekm=10.0**(log10(sizem*0.001)-lstep/2.0)
            sizeupperkm=10.0**(log10(sizem*0.001)+lstep/2.0)
            ...
            print sizem,  eqtimeton(yearstotrask), eqtimeton(yearstohart)
